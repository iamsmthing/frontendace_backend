...
const challenge_progress_1 = __importDefault(require("./routes/challenge-progress"));
...
app.get('/getChallenges', challenge_1.getChallenges);
app.post('/getChallengeById', challenge_1.getChallengeById);
app.post('/createChallenge', challenge_1.createChallenge);
app.post('/bulkCreate', challenge_1.bulkCreateChallenges);
app.delete('/deleteChallenge/:id', challenge_1.deleteChallenge);
// temp route
const projectsData = [
    {
        id: "1",
...
app.use('/v1/api', auth_1.shield, challenge_progress_1.default);
app.use('/v1/api/post', auth_1.shield, post_router_1.default);
app.use('/v1/api/review', auth_1.shield, review_router_1.default);
app.listen(port, () => {
